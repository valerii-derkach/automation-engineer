...
describe('Date.prototype.daysTo', () => {
  test('two full days', () => {
    const d1 = new Date('2024-05-09T00:00:00');
    const d2 = new Date('2024-05-11T00:00:00');
  ...
  test('zero days when the dates are the same', () => {
    const d1 = new Date('2024-05-10T12:00:00');
    const d2 = new Date('2024-05-10T12:00:00');
    expect(d1.daysTo(d2)).toBe(0);
  });

  test('invalid date input', () => {
    const d1 = new Date('2024-05-10T10:00:00');
  ...
  test('returns an error if the second date is earlier', () => {
    const d1 = new Date('2024-05-10T00:00:00');
    const d2 = new Date('2023-05-10T00:00:00');
